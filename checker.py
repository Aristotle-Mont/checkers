...
class Checker(TwoPlayerGame):
    ...
    def lose(self):
        ...
        # if self.white_pieces[0] == self.black_territory:
        #     print("white")
        #     return self.possible_moves() == []

        # elif self.black_pieces[1] == self.white_territory:
        #     print("black")
        #     return self.possible_moves() == []
        ...
        #     print("None")
        #     return self.possible_moves() == []
        # on blacks turn checks white's last move
        if self.current_player == 2:  # this number dictates who's going win n how many oves
            # for each white player check if they are in black territtory
            # if so then Black Loses
            for w in self.players[0].pos:
         ...
         # on blacks turn checks white's last move
            ...
            # for each white player check if they are in black territtory
            # if so then Black Loses
            for b in self.players[1].pos:
                if b in self.white_territory:
